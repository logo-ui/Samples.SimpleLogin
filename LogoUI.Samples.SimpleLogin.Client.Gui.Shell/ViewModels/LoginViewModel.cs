...
{
    public interface ILoginViewModelDescriptor
    {
        IEnumerable LoginOptions { get; }
        string SelectedLogin { get; set; }
        bool IsNetLogin { get; }
        ICommand LoginCommand { get; }
        ICommand CancelCommand { get; }
        bool IsLoginFailureTextVisible { get; }
    ...
    public sealed class LoginViewModel : Screen, ILoginViewModelDescriptor
    {
